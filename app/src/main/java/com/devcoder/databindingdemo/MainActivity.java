...
public class MainActivity extends AppCompatActivity {
    ...
    private void initControl() {
        ...
        list.add(new DataModel("Oreo","8.0"));
        list.add(new DataModel("Nought","7.0"));
        list.add(new DataModel("Mas","6.0"));
        list.add(new DataModel("lolipop","5.0"));
        list.add(new DataModel("kitkate","4.0"));
